...
安装好后查看项目中的 nodejs 的目录, 目录要是 /usr/local/bin/node：
...
npm 全称是 Node Packet Manager，是一个 nodejs 的包管理工具，但是国内下载的速度太慢，建议使用淘宝的国内镜像: 
...
>  安装 generator-jhipster-entity-audit ( https://www.npmjs.com/package/generator-jhipster-entity-audit )  
>
...
>
> **Usage:** This is a [JHipster](http://jhipster.github.io/) module, that is meant to be used in a JHipster application.
>
